...
const atomicHabits: BookSummary = {
  ...
  chapters: [
    ...
    },
    {
      ...
      nodes: [
        { title: 'The Goldilocks Rule', summary: 'Habits should be just right.', deepDive: 'Challenge yourself enough to stay engaged but not overwhelmed.' },
        { title: 'The Two-Minute Rule', summary: 'Start small to build momentum.', deepDive: 'Make habits so easy you can’t say no.' },
      ]
    },
    {
      title: 'Conclusion',
      nodes: [
        { title: 'The Power of Atomic Habits', summary: 'Small changes lead to big transformations.', deepDive: 'Focus on the process, not just the outcome.' },
        { title: 'Continuous Improvement', summary: 'Keep refining your habits.', deepDive: 'Always look for ways to optimize and adapt your habits.' },
      ]
    }
  ]
};
